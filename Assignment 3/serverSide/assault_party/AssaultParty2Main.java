...
public class AssaultParty2Main {
    ...
    public static void main(String[] args) throws SocketException, IOException{
       ...
       String rmiRegHostName;
        ...
        try{
            partyInt = (AssaultPartyInterface) UnicastRemoteObject.exportObject((Remote)party, rc.party2Port());
        }catch(RemoteException ex){
            System.out.println("Excepção na geração do stub para o party2: " + ex.getMessage());
            ex.printStackTrace();
            System.exit(1);
        }
        System.out.println("O stub para o party2 foi gerado!");
        ...
        try {
            ...
            System.out.println("Excepção no registo do party2: " + e.getMessage());
            e.printStackTrace();
            System.exit(1);
        } catch (AlreadyBoundException e) {
            System.out.println("O party2 já está registado: " + e.getMessage());
            e.printStackTrace();
            System.exit(1);
        }
        System.out.println("O party2 foi registado!");
